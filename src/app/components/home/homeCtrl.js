...
function homeCtrl($http, fixtureService, scorersService, $filter, standingsService, $timeout, $window, $rootScope) {
  ...
  var getFixtures = function() {
    fixtureService.getFixtures(vm.todayDate, vm.date2Date)
      .then(function(fixtures) { 
      vm.games = fixtures.matches;

      // Adjust some data as month and day to show '0' in front if less then '10'
