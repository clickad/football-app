...
(function (F) {
  ...
  function Qb(a, b, d) {
    for (var c = a.$$hashKey, e = 0, f = b.length; e < f; ++e) {
      var g = b[e];
      if (J(g) || E(g)) for (var h = Object.keys(g), k = 0, l = h.length; k < l; k++) {
        var m = h[k],
            n = g[m];
        d && J(n) ? ha(n) ? a[m] = new Date(n.valueOf()) : Xa(n) ? a[m] = new RegExp(n) : n.nodeName ? a[m] = n.cloneNode(!0) : Rb(n) ? a[m] = n.clone() : (J(a[m]) || (a[m] = K(n) ? [] : {}), Qb(a[m], [n], !0)) : a[m] = n;
      }
    }
  ...
  function rc(a) {
    return null !== a && "object" === _typeof(a) && !vc(a);
  }
  ...
  function na(a, b) {
    ...
    if (d == _typeof(b) && "object" == d) if (K(a)) {
      if (!K(b)) return !1;
  ...
  function ge() {
    F.name = "NG_ENABLE_DEBUG_INFO!" + F.name;
    F.location.reload();
  }
  ...
  function Qa(a, b, d) {
    ...
    sb(E(a), b, "not a function, got " + (a && "object" === _typeof(a) ? a.constructor.name || "Object" : _typeof(a)));
    return a;
  }
  ...
  function Pf(a, b) {
    b = b || F;
    if ("complete" === b.document.readyState) b.setTimeout(a);else G(b).on("load", a);
  }
    ...
    this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, e, n, w, ka, B, A, H) {
      ...
      function aa(a, b, c, d, e) {
        ...
        for (var f = /\S+/, g = 0, h = a.length; g < h; g++) {
          var k = a[g];
          k.nodeType === Na && k.nodeValue.match(f) && Oc(k, a[g] = F.document.createElement("span"));
        }
      ...
      function s(a, b, c, d, e, f) {
        function g(a, c, d, e) {
          var f, k, l, m, n, u, r;
          if (p) for (r = Array(c.length), m = 0; m < h.length; m += 3) {
            f = h[m], r[f] = c[f];
          } else r = c;
          m = 0;
      ...
      function Ta(a, b, d, e, f, g, h, k, l) {
        ...
        function n(a, c, e, f, g) {
          ...
          var m, p, A, t, H, z, N, D;
          b === e ? (f = d, D = d.$$element) : (D = G(e), f = new Aa(D, d));
          H = c;
        ...
        for (var p = -Number.MAX_VALUE, u = l.newScopeDirective, r = l.controllerDirectives, B = l.newIsolateScopeDirective, x = l.templateDirective, A = l.nonTlbTranscludeDirective, H = !1, z = !1, w = l.hasElementTranscludeDirective, N = d.$$element = G(b), t, M, R, ka = e, s, Ca = !1, va = !1, v, C = 0, F = a.length; C < F; C++) {
          t = a[C];
          var I = t.$$start,
              Ta = t.$$end;
          I && (N = Yc(b, I, Ta));
          ...
          !t.templateUrl && t.controller && (v = t.controller, r = r || S(), W("'" + M + "' controller", r[M], t, N), r[M] = t);
          if (v = t.transclude) if (H = !0, t.$$tlb || (W("transclusion", A, t, N), A = t), "element" == v) w = !0, p = t.priority, R = N, N = d.$$element = G(aa.$$createComment(M, d[M])), b = N[0], ca(f, ya.call(R, 0), b), R[0].$$parentNode = R[0].parentNode, ka = ac(va, R, e, p, g && g.name, {
          ...
          if (t.templateUrl) z = !0, W("template", x, t, N), x = t, t.replace && (g = t), n = Z(a.splice(C, a.length - C), N, d, f, H && ka, h, k, {
            ...
            templateDirective: x,
            nonTlbTranscludeDirective: A
          }), F = a.length;else if (t.compile) try {
            s = t.compile(N, d, ka);
      ...
      function Z(a, b, c, d, f, g, h, k) {
        ...
        e(A).then(function (e) {
          ...
          if (B.replace) {
            ...
            u = e[0];
            if (1 != e.length || 1 !== u.nodeType) throw ea("tplrt", B.name, A);
            e = {
              $attr: {}
            };
            ca(d, b, u);
      ...
      Aa.prototype = {
        ...
        $set: function $set(a, b, d, e) {
          ...
          f = ta(this.$$element);
          if ("a" === f && ("href" === a || "xlinkHref" === a) || "img" === f && "src" === a) this[a] = b = H(b, "src" === a);else if ("img" === f && "srcset" === a && v(b)) {
  ...
  function mf() {
    ...
    this.$get = ["$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function (e, f, g, h, k, l) {
      ...
      function n(c, d) {
        ...
        y(M) && ((M = id(c.url) ? f()[c.xsrfCookieName || a.xsrfCookieName] : void 0) && (Aa[c.xsrfHeaderName || a.xsrfHeaderName] = M), e(c.method, R, d, l, Aa, c.timeout, c.withCredentials, c.responseType, g(c.eventHandlers), g(c.uploadEventHandlers)));
        return A;
      }
      ...
      function k(f, k, n, p) {
        function D(a) {
          try {
            ...
            var d;
            if (p && !v(a)) d = a;else if (null == a) d = "";else {
              switch (_typeof(a)) {
                case "string":
                  break;
    ...
    this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function (d, c, e, f, g) {
      ...
      f.on("click", function (a) {
        if (b.rewriteLinks && !a.ctrlKey && !a.metaKey && !a.shiftKey && 2 != a.which && 2 != a.button) {
          ...
          J(h) && "[object SVGAnimatedString]" === h.toString() && (h = pa(h.animVal).href);
      ...
      c.onUrlChange(function (a, b) {
        y(la(x, a)) ? g.location.href = a : (d.$evalAsync(function () {
          ...
          l.absUrl() === a && (f ? (l.$$parse(c), l.$$state = e, h(c, !1, e)) : (z = !1, k(c, e)));
        }), d.$$phase || d.$digest());
      });
      d.$watch(function () {
        var a = jb(c.url()),
  ...
  function ug(a, b, d) {
    var c = J(a) && "$" in a;
    !0 === b ? b = na : E(b) || (b = function b(a, _b) {
      if (y(a)) return !1;
      if (null === a || null === _b) return a === _b;
      if (J(_b) || J(a) && !uc(a)) return !1;
      a = L("" + a);
      _b = L("" + _b);
        ...
        return {
          ...
          predicateValues: g.map(function (c) {
            ...
            if (null === e) c = "string", e = "null";else if ("string" === c) e = e.toLowerCase();else if ("object" === c) a: {
              ...
              if (uc(e) && (e = e.toString(), d(e))) break a;
              e = b;
            }
            return {
              value: e,
  ...
  var K = Array.isArray,
    ...
    return a.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g, "\\$1").replace(/\x08/g, "\\x08");
      ...
      Fa = function Fa() {
    if (!v(Fa.rules)) {
      var a = F.document.querySelector("[ng-csp]") || F.document.querySelector("[data-ng-csp]");
  ...
  var Tf = F.Node.prototype.contains || function (a) {
    ...
    ready: function ready(a) {
      ...
      var d = !1;
      "complete" === F.document.readyState ? F.setTimeout(b) : (this.on("DOMContentLoaded", b), T(F).on("load", b));
    },
  ...
  q({
    ...
    T.prototype[b] = function (b, c) {
      ...
      if (a !== Sc && y(2 == a.length && a !== zb && a !== Rc ? b : c)) {
        if (J(b)) {
          for (e = 0; e < g; e++) {
    ...
    readString: function readString(a) {
      ...
      for (var d = "", c = a, e = !1; this.index < this.text.length;) {
        var f = this.text.charAt(this.index),
            c = c + f;
        if (e) "u" === f ? (e = this.text.substring(this.index + 1, this.index + 5), e.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + e + "]"), this.index += 4, d += String.fromCharCode(parseInt(e, 16))) : d += Ig[f] || f, e = !1;else if ("\\" === f) e = !0;else {
          if (f === a) {
            this.index++;
            this.tokens.push({
              index: b,
  ...
  s.prototype = {
    ...
    primary: function primary() {
      var a;
      this.expect("(") ? (a = this.filterChain(), this.consume(")")) : this.expect("[") ? a = this.arrayDeclaration() : this.expect("{") ? a = this.object() : this.selfReferential.hasOwnProperty(this.peek().text) ? a = oa(this.selfReferential[this.consume().text]) : this.options.literals.hasOwnProperty(this.peek().text) ? a = {
        type: s.Literal,
  ...
  ud.prototype = {
    ...
    recurse: function recurse(a, b, d) {
      ...
      switch (a.type) {
        ...
        case s.Identifier:
          return Ua(a.name, f.expression), f.identifier(a.name, f.expensiveChecks || Kb(a.name), b, d, f.expression);
  ...
  var Ee = ["$animate", "$compile", function (a, b) {
    ...
    this.$$runValidators = function (a, b, c) {
      ...
      (function () {
        ...
        if (y(z)) f(a, null);else return z || (q(r.$validators, function (a, b) {
          f(b, null);
    ...
    this.$$parseAndValidate = function () {
      ...
      if (z = y(b) ? void 0 : !0) for (var c = 0; c < r.$parsers.length; c++) {
    ...
    return {
      ...
      controller: ["$scope", "$attrs", function (a, b) {
        ...
        v(this.$options.updateOn) ? (this.$options.updateOnDefault = !1, this.$options.updateOn = V(this.$options.updateOn.replace(Pg, function () {
    ...
    return {
      link: function link(f, g, h) {
        ...
        f.$watch(l, function (b) {
          ...
          c === u || e && Q(u) && isNaN(u) || (D(), e = s[c], y(e) ? (null != b && d.debug("ngPluralize: no rule defined for '" + c + "' in " + m), D = C, k()) : D = f.$watch(e, k), u = c);
        });
      }
    };
  }],
        ...
        return function (a, d, f, g, l) {
          ...
          a.$watchCollection(n, function (f) {
            var g,
                ...
                G;
            p && (a[p] = f);
            if (xa(f)) F = f, n = D || u;else for (G in n = D || t, F = [], f) {
            ...
            for (s in m) {
              ...
              A = tb(E.clone);
              b.leave(A);
              if (A[0].parentNode) for (g = 0, n = A.length; g < n; g++) {
                A[g].$$NG_REMOVED = !0;
              }
              E.scope.$destroy();
            }
